...
// IDs for various elements in the extension
const ID = {
...
// IDs for the active areas a site might be in.
const AREA = {
    chat: "chat",
    menu: "menu",
    settings: "settings"
 ...
 * 
 * The base class is used to append the style. The inherited classes should handle the rest.
 */
class PopupWebsite {
    url;
    name;
     ...
     * or other stuff that can interfere with the initialization.
     */
    onLoaded() {
